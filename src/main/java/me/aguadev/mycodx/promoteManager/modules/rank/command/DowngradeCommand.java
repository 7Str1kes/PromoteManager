...
public class DowngradeCommand extends Manager implements CommandExecutor{
    public DowngradeCommand(Promote main) {
        super(main);
    }

    public List<String> usage() {
        return getFiles().getLang().getStringList("downgrade_command.usage");
    }
    @Override
    public boolean onCommand(@NotNull CommandSender sender, @NotNull Command command, @NotNull String label, @NotNull String[] args) {
        ...
        getMain().getRankManager().downgradePlayer(player, target);
        return true;
    }
}
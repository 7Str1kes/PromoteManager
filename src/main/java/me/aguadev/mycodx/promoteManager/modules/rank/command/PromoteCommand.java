...
public class PromoteCommand extends Manager implements CommandExecutor {
    public PromoteCommand(Promote main) {
        super(main);
    }

    public List<String> usage() {
        return getFiles().getLang().getStringList("promote_command.usage");
    }
    ...
    public boolean onCommand(@NotNull CommandSender sender, @NotNull Command command, @NotNull String label, @NotNull String[] args) {
        ...
        getMain().getRankManager().promotePlayer(player, target);
        return true;
    }
}